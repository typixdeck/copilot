...
源码基于 [TypixNode 官方工程](https://github.com/TypixNode/TypixDeck-esp32s3-firmware/tree/fde9dac3b687a92fa2a6a049b5cd953dcb367b23)，应用改造来自本地 `diy-esp32s3-firmware` 工作副本。该候选尚无对应的改造源码提交，因此索引 `commit` 留空；上游提交不代表此产物的可重复构建证明。发布于此处供 Copilot 发现、下载和检查，不代表已获得板级写入批准。保留 [0.2.0](../0.2.0/) 供版本对照。
